// Secciones
const headerSection = document.querySelector(".header-search-container");
const detallesSection = document.querySelector(".main-detalles-container");
...
// Contenedores
const detallesTop = document.querySelector(".detalles-container-top");//
const detallesBot = document.querySelector(".detalles-container-bot");//
const scoreContainer = document.querySelector(".score-container");
const trendingTop = document.querySelector(".trending-container-top");
...
const containerBotTitulo = document.querySelector(".container-bot-bot--titulo");//
const DescriptionMovie = document.querySelector(".container-bot-bot--texto");//
